...
import {
  DesktopFilterMultiselect,
  DesktopFilterMultiselectProps,
} from './DesktopFilterMultiselect';
...
const Template: ComponentStory<typeof DesktopFilterMultiselect> = function (
  args: DesktopFilterMultiselectProps
) {
